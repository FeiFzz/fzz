    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <div class="row-fluid" style="font-size:14px;">
               <form action="../../handle/projects/getProjectlist.action" method="post" name="searchForm">
	            	...
	            	<table>
	                	<tr>
	                        ...
	                        <td>
	                        	<input type="text" id="pname" name="pname" value="${vo.pname}" style="width:160px;"/>
	                        	
	                        </td>
	                        <td align="right" style="padding-left:10px;">开展年份：</td>
	                        <td>
	                        	<input type="text" id="Pyear" name="loginname" value="${vo.pyear}" style="width:160px;"/>
	                        </td>
	                        <%--
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  <tbody>
							  	  <c:forEach items="${ulist}" var="u">
                    					...
                    					<td>${u.pcustomer}</td>                    					
                    					<td>
                    						<a class="btn btn-info" href="../../handle/project/entryEditProject.action?projid=${u.projid}">
                    					...
                    					<td>
	                                        ...
	                                        <c:choose>
												<c:when test="${u.pflag == 1}">
													<a class="btn btn-danger" href="../../handle/user/resetUserFlag.action?userid=${u.projid}&uflag=2">
			                                            <i class="icon-trash icon-white"></i> 
			                                           		 删除
			                                        </a>
												</c:when>
												<c:otherwise>
													<a class="btn btn-success" href="../../handle/user/resetUserFlag.action?userid=${u.projid}&uflag=1">
