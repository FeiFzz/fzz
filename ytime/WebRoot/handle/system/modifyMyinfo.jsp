            ...
            <div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="../../handle/editMyInfo.action" onsubmit="return vform();" name="sform" method="post" class="form-horizontal">
							<fieldset>
							  <input type="hidden" name="userid" value="${sessionScope.online.userid}"/>
							  <div id="div1" class="control-group">
                                <label class="control-label"><span style="color:red">*</span> 用户姓名</label>
								<div class="controls">
								  <input autofocus value="${sessionScope.online.username}" id="username" name="username" type="text" placeholder="请输入用户姓名" oninput="vEname();" onblur="vEname();">
                              ...
                              <div id="div5" class="control-group">
								...
								<div class="controls">
								  <input value="${sessionScope.online.email}" id="email" name="email" type="text" placeholder="请输入电子邮箱">
